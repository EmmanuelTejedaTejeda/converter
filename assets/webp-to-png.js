...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function convertWebpToPng(fileWrapper) {
        ...
        img.onload = () => {
            ...
            // Draw WebP on canvas (supports alpha channel transparent backgrounds)
            ...
            setTimeout(() => {
                canvas.toBlob((blob) => {
                    if (blob) {
                        ...
                        const pngName = fileWrapper.originalName.replace(/\.(webp)$/i, '') + '.png';
    ...
    if (clearAllBtn) {
        ...
        convertAllBtn.addEventListener('click', () => {
            ...
            if (pending.length > 0) {
                playPopSound();
                pending.forEach(f => convertWebpToPng(f));
            }
        });
    }
