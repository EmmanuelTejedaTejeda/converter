...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function handleFiles(files) {
        ...
        filesToProcess.forEach(file => {
            // Validate WebP extension or MIME type
        ...
        if (rejectedCount > 0) {
            const warningMsg = isEnglish 
                ? `Skipped ${rejectedCount} file(s) because they were not in WebP format.`
                : `Se omitieron ${rejectedCount} archivo(s) porque no eran de tipo WebP.`;
            alert(warningMsg);
        }
    ...
    // ==========================================================================
    // WebP to JPG Conversion Core Logic
    // ==========================================================================
    
    function convertWebpToJpg(fileWrapper) {
        ...
        img.onerror = () => {
            URL.revokeObjectURL(objectUrl);
            handleConversionError(fileWrapper, 'Error al cargar imagen / Image loading failed');
        };
    ...
    function handleConversionError(fileWrapper, errorMessage) {
        ...
        console.error(`Conversion error for ${fileWrapper.originalName}:`, errorMessage);
        updateGlobalActionButtons();
    }
    ...
    if (downloadAllBtn) {
        downloadAllBtn.addEventListener('click', () => {
            ...
            if (doneFiles.length > 0) {
                ...
                // Show modal after downloads complete
                setTimeout(() => {
                    showThankYouModal();
                }, delay + 100);
            }
